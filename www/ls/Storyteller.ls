...
</p><p>Graf ve spodní části obrazovky znázorňuje, kolik lidí teroristé v jednotlivých letech zabili – jeden čtvereček představuje jednu oběť. Vybarvené jsou podle toho, která teroristická skupina má útok na svědomí. Každý útok je také zakreslený v mapě."
      * text: "<p>Data čerpáme z <a href='http://www.start.umd.edu/gtd/'>globální databáze teroristických útoků</a> Univerzity v Marylandu. Aktivitu teroristů monitoruje od roku 1970. Na evropském území v tomto období zaznamenala 3 767 útoků a přes šest tisíc obětí.</p><p>Polovinu má na svědomí konflikt v Severním Irsku. Arabský nacionalismus a islámský terorismus si vyžádaly kolem tisíce obětí, baskický separatismus necelých devět set mrtvých. Neofašistické a neonacistické skupiny zabily kolem 250 lidí, stejně jako marxistické guerilly a Rudé brigády dohromady.</p><p>Čísla ukazují, že teror v Evropě – měřeno počtem obětí – vrcholil v sedmdesátých letech, kdy útočníci připravili o život kolem tří stovek lidí ročně.</p>"
      * text: "<p>Od doby, kdy složila zbraně IRA a příměří vyhlásila i baskická ETA, se počet obětí rapidně snížil. Další výrazný pokles je vidět po roce 2001, kdy se i v EU výrazně zpřísnila bezpečnostní opatření nejen na letištích. V posledních letech zemře na následky teroristických útoků v celé Evropské unii kolem deseti lidí ročně.
</p><p>V datech bohužel chybí rok 1993, kdy ale na evropském území podle jiných zdrojů nedošlo k žádnému útoku s velkým počtem obětí. Nenajdete v nich ani letošek, sledujeme pouze data za ukončené roky.</p>"
